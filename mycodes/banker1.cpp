...
int main()
{
	int i=0,a1[5],a2[5],a3[5],m1[5],m2[5],m3[5],n1[5],n2[5],n3[5],c=0,m,count=0,z=0;
    ...
    {
    	fflush(stdin);
    	printf("\nwhich process needs request??\n");
    	scanf("%c%d",&z,&m);
    	printf("enter the request\n");
    	scanf("%d%d%d",&rq1,&rq2,&rq3);
    	if(rq1<=av[0]&&rq2<=av[1],rq3<=av[2]&&rq1<=n1[m]&&rq2<=n2[m]&&rq3<=n3[m])
